...
import static instance.matching.utility.ParamDef.DATA_PROPERTY_INDEX;
import static instance.matching.utility.ParamDef.OBJECT_PROPERTY_INDEX;
...
public class PropertyDetail {
    ...
    public PropertyDetail(String propName, int type) {
