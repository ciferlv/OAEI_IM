...
import instance.matching.unit.Disjoint;
import instance.matching.unit.PropertyDetail;
import instance.matching.unit.SubClass;
...
public class ParamDef {
    ...
    public static int prop_pair_num_need_threshold;

    public static boolean use_supp_file;
